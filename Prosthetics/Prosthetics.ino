...
//---------------------- Константы -----------------------//
//--------------------------------------------------------//
#define debugData false          //для дебага обрабатываемых данных
#define debugLed false          //для дебага индикации светодиодами
#define debugAlg true          //для дебага логики работы прогпаммы

#define workWithLCD true       //отрисовывать на экранчике NOKIA 5110
#define window LCDWIDTH         //сейчас 84, но можно увеличить до 200;  //размер окна
...
const int SERVO_1 = 9;  //цифровой пин вывода сервы, действующей на бинарном методе
const int SERVO_2 = 10;  //цифровой пин вывода, действующей на интерполяционном методе
